...
public class MiniGameDefinition
{
    ...
    ///     <see cref="MUnique.OpenMU.DataModel.Statistics.MiniGameRankingEntry" />.
    /// </summary>
    public bool SaveRankingStatistics { get; set; }

    /// <summary>
    ///     Gets or sets a value indicating whether only characters with <see cref="CharacterClass.IsMasterClass" /> =
    ///     <see langword="true" /> can enter.
    /// </summary>
