...
/// <summary>
///     A <see cref="DropItemGroup" /> which acts a definition of possible items when a special item (e.g. Box of Luck) is
...
public class ItemDropItemGroup : DropItemGroup
{
    ...
    /// <summary>
    ///     Gets or sets the amount of money, in case <see cref="DropItemGroup.ItemType" /> is
    ///     <see cref="SpecialItemType.Money" />.
    /// </summary>
