...
///     For each of this status (<see cref="Discriminator" />), there exist different terrain maps (safezones are
///     different, etc.).
...
public class GameMapDefinition
{
    ...
    /// <summary>
    ///     Gets or sets the discriminator which allows to identify different map definitions with the same
    ///     <see cref="Number" />.
    /// </summary>
