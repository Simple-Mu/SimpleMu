...
public class QuestDefinition
{
    ...
    /// <summary>
    ///     Gets or sets the starting number of the quest which should be unique within the group. It's used as an identifier
    ///     before a quest is started.
    ...
    /// <summary>
    ///     Gets or sets the refuse number of the quest which should be unique within the group. It's used as an identifier
    ///     after a quest has been refused by the player.
