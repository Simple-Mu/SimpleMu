...
public class ItemSetGroup
{
    ...
    /// </summary>
    /// <remarks>
    ///     For example, for the double wear bonus this has to be non-distinct, else we wouldn't get the bonus for wearing two
    ///     of the same kind of swords.
    /// </remarks>
    ...
    ///     The original mu online protocol supports up to two different ancient sets per item - with discriminator values 1
    ///     and 2.
