...
public enum LevelType
{
    ...
    /// </summary>
    /// <remarks>
    ///     As far as I know, this is only required for wing options, e.g. 'Increase max HP +50~115'. That's why
    ///     <see cref="OptionLevel" /> is the default, too.
    /// </remarks>
    ItemLevel
}
...
{
    /// <summary>
    ///     Gets or sets a value which defines by which "level" the option is increased with
    ///     <see cref="LevelDependentOptions" />.
    /// </summary>
    /// <value>
