...
public class CharacterClass
{
    ...
    /// <summary>
    ///     Gets or sets the creation allowed flag which is sent to the client in the character list message if this character
    ///     class is in its <see cref="Account.UnlockedCharacterClasses" />.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    ///     Gets or sets a value indicating whether this class is a master class and therefore can receive master experience
    ///     for the master tree.
    /// </summary>
