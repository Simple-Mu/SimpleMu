...
public class ChatServerDefinition
{
    ...
    /// <summary>
    ///     Gets or sets the client timeout. When a client did not send any data in this timespan, it's automatically
    ///     disconnected.
    /// </summary>
    /// <value>
    ///     The client timeout.
    ...
    {
        return $"[ChatServerDefinition ServerID={ServerId}, Description={Description}]";
    }
}