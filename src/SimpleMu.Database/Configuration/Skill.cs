...
public enum SkillType
{
    ...
    /// <summary>
    ///     The passive boost skill type. Applies boosts to the player who has learned this skill, without the need to be
    ///     casted.
    /// </summary>
    PassiveBoost = 7,
...
public enum SkillTarget
{
    ...
    /// <summary>
    ///     The primary target is stated explicitly, additional targets are all objects in the
    ///     <see cref="Skill.ImplicitTargetRange" /> of the primary target.
    /// </summary>
...
public class Skill
{
    ...
    /// </summary>
    /// <remarks>
    ///     Possible use cases: Additional hits for the "Fireburst" or "Deathstab" skills. They use direct targeting, but also
    ///     hit nearby enemies.
    /// </remarks>
