...
///     That means, when a character looks to south, it looks straight downwards. Because the map is rotated on the game
///     client, that's actually a corner.
///     Since we use the value 0 as 'Undefined' and the original game client uses value 0 as 'West', this has to be
///     considered when communicating with it.
/// </remarks>
