...
///     When single jewels are needed again, the client can unmix his <see cref="MixedJewel" /> back to several
///     <see cref="SingleJewel" />.
/// </summary>
public class JewelMix
{
    ...
    {
        return $"{SingleJewel?.Name} <> {MixedJewel?.Name}";
    }
}