...
/// </summary>
/// <remarks>
///     You may wonder where the Id is. The original server and this <see cref="IGuildServer" /> uses an integer id for
///     guilds, too.
...
///     We would lose the ability to easily merge two databases (realms), if we do that. Even if we use a separate integer
