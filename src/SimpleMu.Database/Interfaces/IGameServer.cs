...
public interface IGameServer : IManageableServer
{
    ...
    /// <summary>
    ///     Notifies the game server that a chat room got created on the chat server for a player which is online on this game
    ///     server.
    /// </summary>
    /// <param name="playerAuthenticationInfo">
    ///     Authentication information of the player who should get notified about the
    ///     created chat room.
    /// </param>
