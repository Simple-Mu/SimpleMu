...
public class ChatServerAuthenticationInfo
{
    ...
    public ChatServerAuthenticationInfo(byte   index, ushort roomId, string clientName, string hostAddress,
                                        string authenticationToken)
    {
        ...
        AuthenticationRequiredUntil = DateTime.Now.AddSeconds(30);
    }
    ...
    /// <summary>
    ///     Gets the datetime until a authentication of at least two clients is required. If this time passed by, the chat room
